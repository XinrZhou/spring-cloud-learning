...
import com.example.common.domain.PageQuery;
...
public class ItemController {
    ...
    @ApiOperation("分页查询商品")
    @GetMapping("/page")
    public PageDTO<ItemDTO> queryItemByPage(PageQuery query, @RequestHeader(value = "X-Request", required = false) String reqHeader) {
